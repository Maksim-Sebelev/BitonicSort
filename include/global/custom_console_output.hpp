// нейросети наше все круглая правая скобка круглая правая скобка
...
int main() {
    ...
    std::cout << RED HEART " " GREEN HEART " " BLUE HEART RESET_CONSOLE_OUT <<
std::endl; std::cout << ROCKET " " FIRE " " ZAP " Let's go!" RESET_CONSOLE_OUT
<< std::endl;
