...
__kernel void bitonic_sort_gpu_small_blocks_sizes_in_local_mem(__global TYPE* data)
{
...
__kernel void bitonic_sort_gpu_big_steps_big_stages(__global TYPE* data, uint block_size, uint stage_comparing_distance)
{
    uint git1 = get_global_id(0);
...
__kernel void bitonic_sort_gpu_big_steps_small_stages(__global TYPE* data, uint block_size)
{
    uint it1 = get_local_id(0);
    uint git1 = get_global_id(0);
    uint git2;
...
__kernel void bitonic_sort_gpu_part_big_block_sizes_global_mem(__global TYPE* data, uint size)
{
